...
export default function SubcategoryPageClient({ category, subcategory }: SubcategoryPageClientProps) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [category.name, subcategory.name, priceRange, sortBy]);
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-gray-600 mt-2">
            {subcategory.productCount} products in {subcategory.name}
          </p>
        </div>
      </div>
          ...
          <div className={`lg:w-64 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-8">
              ...
              {category.subcategories && category.subcategories.length > 1 && (
                <div className="mb-6">
                  <h3 className="font-medium text-gray-900 mb-3">Other Categories</h3>
